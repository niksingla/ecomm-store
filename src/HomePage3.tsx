...
const HomePage3: React.FC = () => {
  ...
  const bestSellers = [
    { id: 1, name: "Classic Sneakers", price: 89.99, img: "https://images.unsplash.com/photo-1595950653106-6c9ebd614d3a" },
    { id: 2, name: "Athletic Shoes", price: 109.99, img: "https://images.unsplash.com/photo-1608231387042-66d1773070a5" },
    { id: 3, name: "Leather Boots", price: 149.99, img: "https://images.unsplash.com/photo-1600585154340-be6161a56a0c" },
  ];
